...
export const AgendaEmptyState: React.FC<AgendaEmptyStateProps> = ({ className = "" }) => {
  ...
  return (
    ...
    >
      <div className="flex h-14 w-14 items-center justify-center rounded-full border border-velora-gold/20 bg-velora-gold/5 text-velora-gold mb-4 shadow-[0_4px_10px_color-mix(in srgb, var(--color-velora-gold) 5%, transparent)]">
