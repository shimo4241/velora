      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-md overflow-hidden rounded-[32px] border border-white/10 bg-velora-black/60 p-6 shadow-2xl backdrop-blur-2xl"
          >
            {/* Header */}
            ...
            <div className="relative aspect-square w-full overflow-hidden rounded-2xl bg-black/40 border border-white/5">
                ...
                <div className="pointer-events-none absolute inset-0 z-20 flex items-center justify-center">
                  <div className="relative h-2/3 w-2/3">
                    ...
                    <motion.div
                      ...
                      className="absolute left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-velora-gold to-transparent shadow-[0_0_12px_#d4af37]"
                    />
                  </div>
                </div>
              )}
              ...
              {isInitializing && (
                <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-velora-black/80 backdrop-blur-sm">
                ...
                <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-velora-black/90 px-8 text-center">
                  ...
                  {!hasPermission && (
                    <button
                      ...
                      className="mt-5 rounded-full border border-velora-gold/30 bg-velora-gold/10 px-5 py-2 text-xs font-semibold text-velora-gold backdrop-blur-md transition-all hover:bg-velora-gold/20"
                    >
                      Actualiser la page
                    </button>
                  )}
            ...
            {/* Action Bar Footer */}
            <div className="mt-6 flex items-center justify-center border-t border-white/5 pt-4 text-center">
