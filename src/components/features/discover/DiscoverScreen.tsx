...
import { FadeUp } from "@/components/features/motion/animations";
import { RadarVisualization } from "./RadarVisualization";
import { IcebreakersCarousel } from "./IcebreakersCarousel";
import MesReseaux from "@/components/shared/MesReseaux";
import { useTranslation } from "@/lib/i18n";
import { ProfessionalCard } from "@/components/features/network";
...
export function DiscoverScreen() {
  ...
  return (
    <div className="discover-screen min-h-screen pb-28 text-velora-text">
      ...
      {/*  Proximity controls  */}
      <section className="relative px-5 pt-4 z-10">
      ...
      <IcebreakersCarousel users={nearbyUsers} loading={loadingDiscover} />
